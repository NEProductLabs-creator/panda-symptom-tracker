...
export default function OnboardingStart() {
  ...
  const { setJourneyStageAsync, completeOnboardingAsync, isSettingStage, isCompletingOnboarding } = useJourneyState();
  const isMutating = isSettingStage || isCompletingOnboarding;
          ...
          {OPTIONS.map((option) => {
            ...
            return (
              ...
              >
                ...
                {/* Active indicator / saving spinner */}
                {isActive && (
