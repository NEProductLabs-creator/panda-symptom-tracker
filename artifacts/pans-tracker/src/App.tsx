...
const clerkAppearance = {
  ...
  variables: {
    colorPrimary: "hsl(155, 21%, 23%)",
    colorForeground: "hsl(155, 15%, 14%)",
    colorMutedForeground: "hsl(157, 10%, 45%)",
    colorDanger: "hsl(0, 40%, 60%)",
    colorBackground: "hsl(39, 47%, 93%)",
    colorInput: "hsl(40, 30%, 76%)",
    colorInputForeground: "hsl(155, 15%, 14%)",
    colorNeutral: "hsl(40, 30%, 76%)",
