  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-14 bg-background">
      <div className="w-full max-w-lg text-center space-y-6">
        ...
        >
          <LifeBuoy className="w-8 h-8" style={{ color: "var(--terracotta)" }} />
        </div>
        ...
        <p className="text-base text-muted-foreground leading-relaxed max-w-md mx-auto">
          Immediate, practical steps for families in the middle of a flare —
          written by parents who have been there. You are not alone in this
          moment, and there are concrete things you can do today.
        </p>
